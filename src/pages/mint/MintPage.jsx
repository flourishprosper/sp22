            ...
            <div className='collection-details'>
              ...
              <div>
                <label>
                  ...
                  I accept the{' '}
                  <a
                    href='https://www.spatial-port.com/terms-conditions'
                    rel='noreferrer'
                    target='_blank'
                  >
                    Terms & Conditions
                  ...
                  and{' '}
                  <a
                    href='https://www.spatial-port.com/privacy-policy'
                    rel='noreferrer'
                    target='_blank'
                  >
                    Privacy Policy
          ...
          <div className='sp-right-content'>
            {minted === 1 && progressValue === 100 && (
              <>
                ...
                <div className='edition-link'>DNA: {dna}</div>
                <h4>{desc}</h4>
                <div className='btn-group'>
                  ...
                  <button
                    ...
                    onClick={() => {
                      window.open(
                        `https://testnets.opensea.io/assets/${process.env.REACT_APP_CONTRACT_ADDRESS}/${totalSupply}`
                      );
                    }}
                  >
                    OPENSEA
